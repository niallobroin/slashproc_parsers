    ...
    def get_vars():
        ...
        descs = {
            ...
            'kstack_depth_to_print': {
                ...
                'label': "Kernel Stack Print Depth",
                'parents': ['Kernel']
            },
            ...
            'panic_on_unrecovered_nmi': {
                'desc': "Kernel behaviour in case of unrecovered NMI. The default Linux behaviour on an NMI of either memory or unknown is to continue operation. For many environments such as scientific computing it is preferable that the box is taken out and the error dealt with than an uncorrected parity/ECC error get propagated",
